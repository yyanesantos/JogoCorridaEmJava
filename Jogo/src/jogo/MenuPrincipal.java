...
public class MenuPrincipal extends JFrame{
	...
	public void criarMenu() {
		...
		menuCreditos.setToolTipText("Colaboradores e inspiracoes para o jogo.");
		menuCreditos.addMenuListener(new MenuListener() {
			...
			public void menuSelected(MenuEvent e) {
				JOptionPane.showMessageDialog(null, "Programa criado pelos alunos José Hilton e Yane dos Santos"
						...
						+ "Computacao no IFCE.", "Créditos", JOptionPane.PLAIN_MESSAGE);
			}
	...
	public void menuPoseidon () {
		...
		JLabel poseidonInfo = new JLabel("<html>Poseidon era o deus grego dos mares e dos rios."
				+ "Os gregos consideravam que ele era responsavel por catastrofes como enchentes e terremotos."
				+ "Era filho de Cronos e Reia e foi resgatado do ventre de seu pai pelo seu irmao Zeus."
				+ "Acredita-se que o culto a Poseidon seja advindo do período micenico.</html>");
	...
	public void menuHades () {
		...
		JLabel hadesInfo = new JLabel("<html>Hades foi um deus grego do submundo e o responsável "
				...
				+ " Era irmao de Zeus e casado com Persefone."
				+ " Hades era o deus do submundo e contava com a ajuda de seu cao de tres cabecas, Cerbero, "
				+ "para impedir que as almas fugissem de la.</html>");
	...
	public void menuZeus() {
		...
		JLabel zeusInfo = new JLabel("<html>Zeus era a divindade suprema na religiosidade dos gregos antigos."
				+ "Era conhecido como deus dos ceus, do raio e do trovao e era filho de Cronos e Reia."
				+ "Foi salvo pela mae de ser devorado pelo próprio pai e,"
				+ "depois de adulto, resgatou seus irmaos e vingou-se de seu genitor.</html>");
    ...
    public void menuEscolherPersonagem(String modoDeJogo) {
    	...
    	JPanel zeusPainel = new JPanel(new FlowLayout());
            ...
            imagemCarroZeus.setIcon(carroZeus);
        ...
        JPanel poseidonPainel = new JPanel(new FlowLayout());
    		...
    		imagemCarroPoseidon.setIcon(carroPoseidon);
        ...
        JPanel hadesPainel = new JPanel(new FlowLayout());
    		...
    		imagemCarroHades.setIcon(carroHades);
